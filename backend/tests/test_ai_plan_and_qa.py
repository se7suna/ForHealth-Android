...
@pytest.mark.asyncio
async def test_ask_question_invalid_type(auth_client: AsyncClient):
    """
    测试无效问题类型的错误处理
    """
    payload = {
    ...
    assert "不支持的问题类型" in data["detail"] or "question_type" in data["detail"].lower(), "错误消息应提到问题类型"
